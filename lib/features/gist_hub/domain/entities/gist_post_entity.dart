  ...
  void _showFeedback(BuildContext context, String message, {bool isError = false}) {
    ...
    scaffoldMessenger.showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? NGColors.error : NGColors.info,
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: const BorderSide(color: NGColors.divider, width: 0.5),
      ),
            ...
            children: [
              if (isTrending)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: NGColors.error.withOpacity(0.15),
                    borderRadius: BorderRadius.circular(8.0),
                    border: const BorderSide(color: NGColors.error, width: 0.5),
                  ),
                  child: const Text(
                    '🔥 TRENDING',
                    style: TextStyle(color: NGColors.error, fontWeight: FontWeight.bold, fontSize: 11.0),
                  ),
                ),
              if (gistType == GistType.announcement)
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 3),
                  decoration: BoxDecoration(
                    color: NGColors.themePurple.withOpacity(0.15),
                    borderRadius: BorderRadius.circular(8.0),
                    border: const BorderSide(color: NGColors.themePurple, width: 0.5),
                  ),
                  child: Text(
                    announcementType == GistAnnouncementType.pollWinner ? '🗳️ POLL WINNER' : 'ANNOUNCEMENT',
                    style: const TextStyle(color: NGColors.themePurple, fontWeight: FontWeight.bold, fontSize: 11.0),
                  ),
                ),
            ],
          ),
...
class GistWinnerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: NGColors.themePurple.withOpacity(0.1),
        borderRadius: BorderRadius.circular(borderRadius),
        border: const BorderSide(color: NGColors.themePurple, width: 0.8),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: const [
              Icon(Icons.stars, color: NGColors.themePurple, size: 18),
              S线条width: 6,
              Text(
                'OFFICIAL POLL RESULT',
                style: TextStyle(color: NGColors.themePurple, fontWeight: FontWeight.bold, fontSize: 12),
              ),
            ],
          ),
      ...
      children: [
        ...
        if (expiresAt != null)
          Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.timer, size: 14, color: canVote ? NGColors.info : NGColors.error),
                const SizedBox(width: 4),
                Text(
                  canVote ? _formatRemainingTime(remainingDuration) : 'Voting Period Concluded',
                  style: TextStyle(color: canVote ? NGColors.textSecondary : NGColors.error, fontSize: 12, fontWeight: FontWeight.w500),
                ),
              ],
            ),
          ),
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(8),
            border: const BorderSide(color: NGColors.divider, width: 1),
          ),
          child: Stack(
            children: [
              Align(
                ...
                child: FractionallySizedBox(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: NGColors.info.withOpacity(0.15),
...
class GistPollProgressMeter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: NGColors.surfaceLight.withOpacity(0.5),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text('$currentRequests/$threshold requested', style: const TextStyle(color: NGColors.info, fontSize: 12, fontWeight: FontWeight.bold)),
            ],
          ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: const AlwaysStoppedAnimation<Color>(NGColors.info),
              minHeight: 5,
            ),
          ),
        ],
              ...
              child: const Center(
                child: SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    strokeWidth: 2.5,
                    valueColor: AlwaysStoppedAnimation<Color>(NGColors.info),
                  ),
                ),
              ),
            ),
        ...
        Row(
          ...
          children: [
            if (pollStatus == GistPollStatus.none)
              IconButton(
                icon: const Icon(Icons.how_to_vote, size: 20, color: NGColors.info),
