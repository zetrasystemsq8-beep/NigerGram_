...
import 'package:nigergram/features/video_feed/presentation/view/widgets/video_feed_view_item.dart'; // ✅ Fixed path
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return VideoFeedViewItem(
                  ...
                  // 🔥 Pass the actual functions – you need to implement these
                  onLike: () {
                    // Your existing Like logic
                    context.read<VideoFeedCubit>().toggleLike(state.videos[index].id);
                  },
                  onComment: () {
                    // Your existing Comment logic
                    // Example: showCommentsBottomSheet(context, state.videos[index].id);
                  },
                  onShare: () {
                    // Your existing Share logic
                    // Example: showShareBottomSheet(context, state.videos[index].id);
                  },
                );
              },
            ),
